...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    double driveRS = m_driver.getRightX(); //gets Y axis of the right stick for the driver's controller (port 0).
    Drivetrain.arcadeDrive(driveLS, driveRS,1);  //The driver is able to control the robot using tank drive.
    }
  /**
